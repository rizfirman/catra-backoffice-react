    ...
    <div className="login flex min-h-screen w-full flex-col grow">
      ...
      <div className="flex h-auto w-screen flex-row grow p-5">
        <div className="flex w-full justify-center  items-center ">
          <div>
            <p className="text-[32px] font-normal font-inter">Catra Backoffice</p>
            <p className="text-[32px] font-normal font-inter">Login</p>
            <p className="text-[18px] font-normal font-inter">Masukan Username dan Password untuk Log In</p>
            <input
            ...
            <button className="bg-[#1E40AF] rounded-[4px] mt-2 text-[12px] font-normal text-white  font-inter w-[54px] h-[30px]">
              Login
            </button>
          </div>
        </div>
      ...
      <div className="flex h-32 w-screen justify-center">
        <p className="text-[14px] font-[500] font-inter">Copyright 2022. All Right Reserved</p>
      </div>
    </div>
  );
}
